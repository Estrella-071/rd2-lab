...
src/infra/   HTTP, storage, viewport, WebGL, and image export adapters
...
- The Spine adapter owns one active WebGL context and disposes it during teardown.
...
- `site/boss_event_data.json` and `site/monster_visuals.json` define the compendium.
