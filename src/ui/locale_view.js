...
export class LocaleView {
  constructor({ localization, widgetElement, morphingWidgets, onLocaleChange } = {}) {
    ...
    this.onLocaleChange = typeof onLocaleChange === "function" ? onLocaleChange : null;
    ...
    this._boundClick = (event) => {
      ...
      if (SUPPORTED_LOCALES.includes(locale)) {
        const changed = this.localization?.setLocale(locale);
        if (changed && this.onLocaleChange) this.onLocaleChange(locale);
