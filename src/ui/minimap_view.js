...
export class MinimapView {
  ...
  render(state) {
    ...
    // No hard clamping allows smooth rubber-band visual reflection
    this.windowEl.style.left = `${leftPercent}%`;
    this.windowEl.style.top = `${topPercent}%`;
    this.windowEl.style.width = `${widthPercent}%`;
    this.windowEl.style.height = `${heightPercent}%`;
  }
