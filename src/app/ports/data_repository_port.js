...
export class DataRepositoryPort {
  ...
  /**
   * Load the static monster poster manifest.
   * @param {string} [url] - Optional override URL
   * @returns {Promise<object>} Parsed monster poster manifest
   */
  async loadMonsterPosters(url) {
    throw new Error("DataRepositoryPort.loadMonsterPosters must be implemented by an adapter.");
  }
