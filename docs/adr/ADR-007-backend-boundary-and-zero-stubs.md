...
The published application is a static client. Storage, HTTP, WebGL, and viewport behavior enter the application through ports and concrete adapters. Every committed module has a working purpose, a defined owner, and a matching verification path.
