...
const UI = {
  ...
  "node.type.perk": { "zh-tw": "輔助特性", en: "Support perk", ja: "サポート特性", ko: "지원 특성" },
  ...
  "compendium.spineReplay": { "zh-tw": "點擊重新播放 Spine 動畫", en: "Click to replay the Spine animation", ja: "クリックしてSpineアニメーションを再生", ko: "클릭해 Spine 애니메이션 다시 재생" },
  "compendium.static": { "zh-tw": "靜態", en: "STATIC", ja: "静止画", ko: "정지 이미지" },
