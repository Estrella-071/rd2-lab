...
| Assets and staging | `npm run check:assets`, `npm run check:staging` | PNG inventory, ESM graph, Spine files, allowlist, and runtime manifest |
...
| Pages performance | `npm run check:performance` | artifact size, startup, long tasks, zoom, emulated mobile pan, and Spine lifecycle budgets |
