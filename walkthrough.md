...
2. The tree view renders 239 nodes and 246 effective directed edges; the raw 248-edge client projection and two reward-root corrections remain in lineage evidence.
...
| Data | `npm run validate:data` | 239 nodes, 246 effective edges (248 raw edges), valid node types, and acyclic topology |
...
| Staging | `npm run check:staging` | ESM, data, static poster files, and manifest are aligned |
