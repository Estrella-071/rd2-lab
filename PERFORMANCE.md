...
startup and parse work, pan and zoom responsiveness, and the single-context
Spine lifecycle.
...
| Spine | second-monster switch time, peak active contexts, context-loss events, and contexts remaining after close |
...
ceiling. Artifact, startup, frame-tail, Spine, and runtime limits stay the same
in both profiles.
